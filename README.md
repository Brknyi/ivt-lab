...
- van torpedó, de másikban nincs (SINGLE)
- nincs torpedó, de másik store-ban van (ALL)
- nincs torpedó és másik store-ban nincs (ALL)
- nincs torpedó és másik store-ban van (SINGLE)
